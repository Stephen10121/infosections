...
<div class="main max-w-5xl mx-auto space-y-6 isolate">
	...
	<div class="grid gap-6 lg:grid-cols-3">
		<div class="lg:col-span-2 space-y-6">
			<form
				{...updateImageFeedForm.enhance(async ({ submit, element }) => {
			...
			>
				...
				<IFeedAvatar
					...
					avatarLink={selectedImageFeed.logo
						? `${data.pb_url}/api/files/${selectedImageFeed.collectionId}/${selectedImageFeed.id}/${selectedImageFeed.logo}`
						: ""}
				/>
				...
				<IFeedDisplaySettings
					displaySettings={selectedImageFeed.displaySettings}
				...
				<IFeedFilterSettings
					filters={selectedImageFeed.filters}
			...
			<div class="space-y-6">
				...
				<IFeedIncludedCalendars
					feedId={selectedImageFeed.id}
					pb_url={data.pb_url}
					additionalCalendars={selectedImageFeed.additionalCalendars}
				/>
			</div>
		</div>
