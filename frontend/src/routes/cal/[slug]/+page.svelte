...
<div id="cal-root" class="dark min-h-screen w-full bg-background relative">
    <Calendar calId={data.id} events={events} displaySettings={data.displaySettings} timeZone={timeZone} filters={data.filters} {fontScale} />
    <Popover.Root>
        ...
        <Popover.Content class="text-muted-foreground bg-foreground rounded p-2 flex flex-col gap-3" style="border: 1px solid #333333">
