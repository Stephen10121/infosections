		...
		<div class="grid grid-cols-1 gap-6">
			<div class="flex items-center justify-between space-x-2">
				<Label for="showEventExtraInfo" class="flex flex-col items-start space-y-1 cursor-pointer">
					...
					<span class="text-sm text-muted-foreground"
						>If a description of an event was set, you can choose if you want to display that info.</span
					>
				</Label>
				<input
					{...updateImageFeedForm.fields.displaySettings.showEventExtraInfo.as("checkbox")}
					class="sr-only"
					bind:checked={displaySettingsBindable.showEventExtraInfo}
					type="checkbox"
				/>
				<Switch id="showEventExtraInfo" bind:checked={displaySettingsBindable.showEventExtraInfo} />
			</div>
			...
			{#if displaySettingsBindable.showEventExtraInfo}
				<div class="flex items-center justify-between space-x-2 ml-5">
					...
					<input
						{...updateImageFeedForm.fields.displaySettings.showEventName.as("checkbox")}
						class="sr-only"
				...
				<div class="flex items-center justify-between space-x-2 ml-5">
					...
					<input
						{...updateImageFeedForm.fields.displaySettings.showEventDescription.as("checkbox")}
						class="sr-only"
				...
				<div class="flex items-center justify-between space-x-2 ml-5">
					...
					<input
						{...updateImageFeedForm.fields.displaySettings.showEventRegistration.as("checkbox")}
						class="sr-only"
			...
			<div class="space-y-2">
				<input
					class="sr-only"
					{...updateImageFeedForm.fields.displaySettings.feedDurationMS.as("number")}
				...
				<Label for="feedDurationMS" class="flex flex-col items-start space-y-1 cursor-pointer">
					...
					<span class="text-sm text-muted-foreground"
						>How long you want to show each slide in milliseconds.</span
					>
				</Label>
				<Input
					id="feedDurationMS"
