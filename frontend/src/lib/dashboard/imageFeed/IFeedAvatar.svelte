            ...
            <div class="relative">
                {#if avatarLinkBindable.length > 0 || uploadNewAvatar}
                    {#if avatarLinkBindable.length > 0}
                        <input {...updateImageFeedForm.fields.avatarLink.as("hidden", avatarLinkBindable)} />
                    {/if}
            ...
            <div class="flex-1 space-y-3">
                ...
                <div class="flex gap-2">
                    <Button variant="outline" class="relative bg-transparent">
                        ...
                        Upload Image
                        <input
                            {...(updateImageFeedForm.fields.newAvatar as unknown as RemoteFormField<File>).as("file")}
