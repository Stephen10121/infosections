<script lang="ts">
	import {
		getCustomImagesForIFeed,
		getMyImageFeeds
	} from "../../../routes/(mainWebsite)/dashboard/backend.remote";
...
<Card.Root>
	<Card.Header>
		...
		<Card.Description
			...
			not reflected in Ifeed preview!)</Card.Description
		>
	</Card.Header>
	<Card.Content>
		<CustomImages
			customImages={await getCustomImagesForIFeed(feedId)}
			apiServer={pb_url}
