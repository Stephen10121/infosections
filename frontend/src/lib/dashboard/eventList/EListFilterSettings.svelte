    ...
    <Card.Content>
        <div class="grid grid-cols-1 gap-6">
            <div class="flex items-center justify-between space-x-2">
                ...
                <input {...updateEventListForm.fields.filters.onlyShowFeatured.as("checkbox")} class="sr-only" bind:checked={filtersBindable.onlyShowFeatured} type="checkbox" />
                <Switch
                    id="onlyShowFeatured"
            ...
            <div class="flex items-center justify-between space-x-2">
                ...
                <input {...updateEventListForm.fields.filters.hideUnpublished.as("checkbox")} class="sr-only" bind:checked={filtersBindable.hideUnpublished} type="checkbox" />
                <Switch
                    id="hideUnpublished"
            ...
            <div class="flex items-center justify-between space-x-2">
                ...
                <input {...updateEventListForm.fields.filters.hideRecurringEvents.as("checkbox")} class="sr-only" bind:checked={filtersBindable.hideRecurringEvents} type="checkbox" />
                <Switch
                    id="hideRecurringEvents"
