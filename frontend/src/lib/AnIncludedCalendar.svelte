	...
	<div class="flex items-center gap-4 rounded-lg border border-border p-4">
		...
		<div class="flex-1 min-w-0">
			<div class="flex items-center gap-2">
				<a href="/dashboard/calendars/{calendarId}"
					><h4 class="font-medium truncate underline">{actualCalendar.name}</h4></a
				>
						...
						<Tooltip.Provider>
							<Tooltip.Root>
								...
								<Tooltip.Content
									...
									settings of this calendar.</Tooltip.Content
								>
							</Tooltip.Root>
						</Tooltip.Provider>
					</div>
						...
						<Tooltip.Provider>
							<Tooltip.Root>
								...
								<Tooltip.Content
									...
									calendar immediently!</Tooltip.Content
								>
							</Tooltip.Root>
						</Tooltip.Provider>
					</div>
		...
		<Button
			...
			onclick={() => removeAdditionalCalendar(calendarId)}><X /></Button
		>
	</div>
{/if}
