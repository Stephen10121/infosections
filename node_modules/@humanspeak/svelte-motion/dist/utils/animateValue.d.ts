import { type AnimationSequence, type ObjectTarget, type SequenceOptions } from 'motion';
import type { AnimationOptions, AnimationPlaybackControlsWithThen, DOMKeyframesDefinition, ElementOrSelector, UnresolvedValueKeyframe, ValueAnimationTransition } from 'motion-dom';
...
export interface SvelteMotionAnimate {
    ...
    (value: string | AnyMotionValue<string>, keyframes: string | UnresolvedValueKeyframe<string>[], options?: ValueAnimationTransition<string>): AnimationPlaybackControlsWithThen;
    /** Animate a numeric motion value (raw or augmented). */
    (value: number | AnyMotionValue<number>, keyframes: number | UnresolvedValueKeyframe<number>[], options?: ValueAnimationTransition<number>): AnimationPlaybackControlsWithThen;
    /** Animate a motion value of any keyframe-compatible type (raw or augmented). */
    <V extends string | number>(value: V | AnyMotionValue<V>, keyframes: V | UnresolvedValueKeyframe<V>[], options?: ValueAnimationTransition<V>): AnimationPlaybackControlsWithThen;
 ...
 * ```
 */
export declare const animate: SvelteMotionAnimate;
