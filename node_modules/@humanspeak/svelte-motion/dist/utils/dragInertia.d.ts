import { type AnimationPlaybackControlsWithThen, type KeyframeGenerator, type ValueAnimationOptions } from 'motion-dom';
/**
 ...
 * ```
 */
export declare const createDragInertiaOptions: (options: DragInertiaAxisOptions) => ValueAnimationOptions<number>;
/**
 ...
 * ```
 */
export declare const startDragInertia: (options: DragInertiaAxisOptions, handlers: {
 ...
 * ```
 */
export declare const createDragInertiaGenerator: (options: DragInertiaAxisOptions) => KeyframeGenerator<number>;
