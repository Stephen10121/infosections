...
const activeFlipAnimations = new WeakMap();
const rememberFlipAnimation = (el, animation, cleanup = () => { }) => {
 ...
 * ```
 */
export const finishFlipAnimations = (el) => {
 ...
 * ```
 */
export const selectLayoutDependencies = (layoutDependency, fallback) => (layoutDependency !== undefined ? [layoutDependency] : fallback());
/**
