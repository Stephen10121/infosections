import { type FollowValueOptions, type SpringOptions, type TransformOptions } from 'motion-dom';
import { type AugmentedMotionValue } from './augmentMotionValue.svelte.js';
import { type MotionValueSource } from './toMotionValue.svelte.js';
/**
 ...
 * ```
 */
export declare const motionValue: <T = number>(initial: T) => AugmentedMotionValue<T>;
/**
 ...
 * ```
 */
export declare function springValue(source: number | MotionValueSource<number>, options?: SpringValueOptions): AugmentedMotionValue<number>;
export declare function springValue(source: string | MotionValueSource<string>, options?: SpringValueOptions): AugmentedMotionValue<string>;
/**
 ...
 * ```
 */
export declare const transformValue: <O>(compute: () => O) => AugmentedMotionValue<O>;
/**
 ...
 * ```
 */
export declare const mapValue: <O>(source: MotionValueSource<number>, inputRange: number[], outputRange: O[], options?: TransformOptions<O>) => AugmentedMotionValue<O>;
