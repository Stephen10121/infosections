import { buildSVGPath, camelCaseAttributes, camelToDash, isMotionValue } from 'motion-dom';
/**
 ...
 */
export const resolveSVGAttrKey = (key) => {
 ...
 */
export const isSVGMotionValueAttribute = (key) => {
    if (SVG_PATH_PROPERTIES.has(key))
        return false;
    if (/^attr[A-Z]/.test(key))
        return true;
 ...
 */
export const extractSVGMotionValueAttributes = (rest) => {
    const motionValueAttrs = {};
    const staticAttrs = {};
 ...
 */
export const computeSSRSVGAttrValues = (motionValueAttrs) => {
    const attrs = {};
 ...
 */
export const resolveSVGTagName = (tag) => {
