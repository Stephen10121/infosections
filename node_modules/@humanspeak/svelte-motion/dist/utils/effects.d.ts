 ...
 * ```
 */
export declare const styleEffect: Effect;
/**
 ...
 * ```
 */
export declare const attrEffect: Effect;
/**
 ...
 * ```
 */
export declare const propEffect: (subject: object, values: EffectValues) => VoidFunction;
/**
 ...
 * ```
 */
export declare const svgEffect: Effect;
export {};
