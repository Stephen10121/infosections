const compareMin = (a, b) => a.layout.min - b.layout.min;
/**
 ...
 */
export const upsertOrderEntry = (order, value, layout) => {
 ...
 */
export const removeOrderEntry = (order, value) => {
    const index = order.findIndex((entry) => entry.value === value);
    if (index !== -1) {
 ...
 */
export const applyOrderSwap = (values, order, newOrder) => {
