...
const isScrollableElement = (element, axis) => {
...
const findScrollableAncestor = (element, axis) => {
 ...
 */
const getScrollAmount = (pointerPosition, scrollElement, axis) => {
 ...
 */
export const autoScrollIfNeeded = (groupElement, pointerPosition, axis, velocity) => {
    if (!groupElement)
        return;
