import type { Axis, Box } from '../../utils/projection';
/**
 ...
 */
export declare const setReorderContext: <V>(context: ReorderContextProps<V>) => void;
/**
 * Read the nearest `Reorder.Group` contract, or `undefined` when not
 * inside one — `Reorder.Item` treats that as a usage error.
 */
export declare const getReorderContext: <V>() => ReorderContextProps<V> | undefined;
